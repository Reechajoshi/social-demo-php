<html>
<head>
<title>{$admin_lostpass_reset10}</title>
...
<td>
  ...
  <td class='box'>
    ...
    <div class='page_header'>{$admin_lostpass_reset5}</div>

    {if $valid == 1 AND $submitted == 1}
      {$admin_lostpass_reset6}
    {elseif $valid == 1 AND $submitted == 0}
      {$admin_lostpass_reset7}
      <br><br>
    ...
    <tr>
    <td align='right'>{$admin_lostpass_reset8}&nbsp;</td>
    <td><input type='password' class='text' name='admin_password' maxlength='50' size='40'></td>
    </tr>
    <tr>
    <td align='right'>{$admin_lostpass_reset9}&nbsp;</td>
    ...
    <td>
      ...
      <tr>
      <td valign='top'>
        <input type='submit' class='button' value='{$admin_lostpass_reset10}'>&nbsp;
      ...
      <td valign='top'>
        ...
        <input type='submit' class='button' value='{$admin_lostpass_reset11}'>
        </form>
      </td>
      </tr>
      </table>
