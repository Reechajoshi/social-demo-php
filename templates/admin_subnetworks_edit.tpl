...
<h2>{$admin_subnetworks_edit1}</h2>
{$admin_subnetworks_edit2}
...
<form action='admin_subnetworks_edit.php' method='POST'>
<tr>
<td class='form1'>{$admin_subnetworks_edit3}</td>
<td class='form2'><input type='text' class='text' name='subnet_name' value='{$subnet_name}' size='40' maxlength='50'></td>
</tr>
<tr>
<td class='form1'>{$admin_subnetworks_edit4}</td>
<td class='form2'>
  <table cellpadding='0' cellspacing='0'>
  <tr>
  <td>
  ...
  <option></option>
  <option value='=='{if $field1_qual == "=="} SELECTED{/if}>{$admin_subnetworks_edit6}</option>
  <option value='!='{if $field1_qual == "!="} SELECTED{/if}>{$admin_subnetworks_edit7}</option>
  <option value='>'{if $field1_qual == ">"} SELECTED{/if}>{$admin_subnetworks_edit8}</option>
  <option value='<'{if $field1_qual == "<"} SELECTED{/if}>{$admin_subnetworks_edit9}</option>
  <option value='>='{if $field1_qual == ">="} SELECTED{/if}>{$admin_subnetworks_edit10}</option>
  <option value='<='{if $field1_qual == "<="} SELECTED{/if}>{$admin_subnetworks_edit11}</option>
  </select>&nbsp;
  </td>
  <td>
    {* TEXT FIELD *}
...
<tr>
<td class='form1'>&nbsp;</td>
<td class='form2'>{$admin_subnetworks_edit5}</td>
</tr>
<tr>
<td class='form1'>&nbsp;</td>
<td class='form2'>
  ...
  <option></option>
  <option value='=='{if $field2_qual == "=="} SELECTED{/if}>{$admin_subnetworks_edit6}</option>
  <option value='!='{if $field2_qual == "!="} SELECTED{/if}>{$admin_subnetworks_edit7}</option>
  <option value='>'{if $field2_qual == ">"} SELECTED{/if}>{$admin_subnetworks_edit8}</option>
  <option value='<'{if $field2_qual == "<"} SELECTED{/if}>{$admin_subnetworks_edit9}</option>
  <option value='>='{if $field2_qual == ">="} SELECTED{/if}>{$admin_subnetworks_edit10}</option>
  <option value='<='{if $field2_qual == "<="} SELECTED{/if}>{$admin_subnetworks_edit11}</option>
  </select>&nbsp;
  </td>
  <td>
    {* TEXT FIELD *}
...
<td class='form2'>
  <table cellpadding='0' cellspacing='0'>
  <tr>
  <td><input type='submit' class='button' value='{$admin_subnetworks_edit12}'>&nbsp;</td>
  ...
  <td><input type='submit' class='button' value='{$admin_subnetworks_edit13}'></td>
  </tr>
  <input type='hidden' name='s' value='{$s}'>
  </form>
  </table>
