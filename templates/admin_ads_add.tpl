...
<tr><td class='header'>{$admin_ads_add11}</td></tr>
...
<tr><td class='setting2'>
  ...
  <td id='bannerborder' class='bannerborder{if $ad_html != ""}2{/if}' align='center'>
    ...
    <div id='banner_options' style='{if $ad_html != ""}display: none;{/if}'>
      <h3><b><a href="javascript:hidediv('banner_options');showdiv('banner_upload');">{$admin_ads_add13}</a> &nbsp;&nbsp;{$admin_ads_add14}&nbsp;&nbsp; <a href="javascript:hidediv('banner_options');showdiv('banner_html');">{$admin_ads_add15}</a></b></h3>
    </div>
	...
	<div id='banner_upload_submit'>
          [ <a href="javascript:uploadbanner()">{$admin_ads_add19}</a> ] &nbsp;
          [ <a href="javascript:hidediv('banner_upload');showdiv('banner_options');">{$admin_ads_add20}</a> ]
	</div>
    ...
    <div id='banner_html' style='display: none;'>
      <b>{$admin_ads_add21}</b><br>
      <textarea rows='4' cols='90' class='text' id='bannerhtml'></textarea>
      <div style='margin-top: 5px;'>
        [ <a href="javascript:savebanner();">{$admin_ads_add22}</a> ] &nbsp;
        [ <a href="javascript:hidediv('banner_html');showdiv('banner_options');">{$admin_ads_add20}</a> ]
      </div>
    </div>

    <div id='banner_preview_html' style='display: none;'>
      <div style='margin-bottom: 5px;'><b>{$admin_ads_add24}</b></div>
      <div id='banner_html_content'></div>
      <div style='margin-top: 5px;'>
        [ <a href="javascript:savebanner2();">{$admin_ads_add23}</a> ] &nbsp;
        [ <a href="javascript:hidediv('banner_preview_html');showdiv('banner_html');">{$admin_ads_add20}</a> ]
      </div>
    </div>
    ...
    <div id='banner_preview_upload' style='display: none;'>
      ...
      <div style='margin-top: 5px;'>
        [ <a href="javascript:uploadbanner3();">{$admin_ads_add23}</a> ] &nbsp;
        [ <a href="javascript:uploadbanner3_cancel();">{$admin_ads_add20}</a> ]
      </div>
    ...
    <div id='banner_final_title' style='{if $ad_html == ""}display: none;{/if} padding-bottom: 3px;'><b>{$admin_ads_add24}</b></div>
    <div id='banner_final' style='{if $ad_html == ""}display: none;{/if}'>{$ad_html}</div>
    <div id='banner_final_startover' style='{if $ad_html == ""}display: none;{/if} padding-top: 3px;'><a href="javascript:startover()">{$admin_ads_add25}</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:backtohtml()">{$admin_ads_add65}</a></div>
  ...
  function uploadbanner() {
    ...
    if(bannersrc == "") {
      alert('{/literal}{$admin_ads_add26}{literal}');
    } else {
  ...
  function uploadbanner2(imagename,iserror,error_message) {
    if(iserror == 1) {
      ...
      alert('{/literal}{$admin_ads_add27}{literal}');
    } else {
  ...
  function savebanner() {
    ...
    if(bannerhtml == "") {
      alert('{/literal}{$admin_ads_add28}{literal}');
    } else {
      hidediv('banner_html');
...
<table cellpadding='0' cellspacing='0' width='100%'>
<tr><td class='header'>{$admin_ads_add29}</td></tr>
<tr><td class='setting1'>
{$admin_ads_add30}
<br><br>
<b>{$admin_ads_add31} {$nowdate}</b>
</td></tr>
<tr><td class='setting2'>
  <table cellpadding='0' cellspacing='0'>
  <tr>
  <td class='form1'>{$admin_ads_add32}</td>
  <td class='form2'><input type='text' class='text' name='ad_name' size='64' maxlength='250' value='{$ad_name}'></td>
  </tr>
  <tr>
  <td class='form1'>{$admin_ads_add33}</td>
  <td class='form2'>
    <select class='text' name='ad_date_start_month'>
    <option></option>
    <option{if $ad_date_start_month == "$admin_ads_add34"} selected='selected'{/if}>{$admin_ads_add34}</option>
    <option{if $ad_date_start_month == "$admin_ads_add35"} selected='selected'{/if}>{$admin_ads_add35}</option>
    <option{if $ad_date_start_month == "$admin_ads_add36"} selected='selected'{/if}>{$admin_ads_add36}</option>
    <option{if $ad_date_start_month == "$admin_ads_add37"} selected='selected'{/if}>{$admin_ads_add37}</option>
    <option{if $ad_date_start_month == "$admin_ads_add38"} selected='selected'{/if}>{$admin_ads_add38}</option>
    <option{if $ad_date_start_month == "$admin_ads_add39"} selected='selected'{/if}>{$admin_ads_add39}</option>
    <option{if $ad_date_start_month == "$admin_ads_add40"} selected='selected'{/if}>{$admin_ads_add40}</option>
    <option{if $ad_date_start_month == "$admin_ads_add41"} selected='selected'{/if}>{$admin_ads_add41}</option>
    <option{if $ad_date_start_month == "$admin_ads_add42"} selected='selected'{/if}>{$admin_ads_add42}</option>
    <option{if $ad_date_start_month == "$admin_ads_add43"} selected='selected'{/if}>{$admin_ads_add43}</option>
    <option{if $ad_date_start_month == "$admin_ads_add44"} selected='selected'{/if}>{$admin_ads_add44}</option>
    <option{if $ad_date_start_month == "$admin_ads_add45"} selected='selected'{/if}>{$admin_ads_add45}</option>
    </select>
    ...
    <option></option>
    <option{if $ad_date_start_ampm == "$admin_ads_add46"} selected='selected'{/if}>{$admin_ads_add46}</option>
    <option{if $ad_date_start_ampm == "$admin_ads_add47"} selected='selected'{/if}>{$admin_ads_add47}</option>
    </select>
  </td>
  </tr>
  <tr>
  <td class='form1'>{$admin_ads_add48}</td>
  <td class='form2'>
    ...
    <td><label for='timelimit0'>{$admin_ads_add49}</label></td>
    </tr>
    <tr>
    ...
    <td><label for='timelimit1'>{$admin_ads_add50}</label></td>
    </tr>
    </table>
    ...
    <div style='margin-top: 7px; margin-bottom: 2px;{if $ad_date_end_options != 1} display: none;{/if}' id='enddate'>
      ...
      <option></option>
      <option{if $ad_date_end_month == "$admin_ads_add34"} selected='selected'{/if}>{$admin_ads_add34}</option>
      <option{if $ad_date_end_month == "$admin_ads_add35"} selected='selected'{/if}>{$admin_ads_add35}</option>
      <option{if $ad_date_end_month == "$admin_ads_add36"} selected='selected'{/if}>{$admin_ads_add36}</option>
      <option{if $ad_date_end_month == "$admin_ads_add37"} selected='selected'{/if}>{$admin_ads_add37}</option>
      <option{if $ad_date_end_month == "$admin_ads_add38"} selected='selected'{/if}>{$admin_ads_add38}</option>
      <option{if $ad_date_end_month == "$admin_ads_add39"} selected='selected'{/if}>{$admin_ads_add39}</option>
      <option{if $ad_date_end_month == "$admin_ads_add40"} selected='selected'{/if}>{$admin_ads_add40}</option>
      <option{if $ad_date_end_month == "$admin_ads_add41"} selected='selected'{/if}>{$admin_ads_add41}</option>
      <option{if $ad_date_end_month == "$admin_ads_add42"} selected='selected'{/if}>{$admin_ads_add42}</option>
      <option{if $ad_date_end_month == "$admin_ads_add43"} selected='selected'{/if}>{$admin_ads_add43}</option>
      <option{if $ad_date_end_month == "$admin_ads_add44"} selected='selected'{/if}>{$admin_ads_add44}</option>
      <option{if $ad_date_end_month == "$admin_ads_add45"} selected='selected'{/if}>{$admin_ads_add45}</option>
      </select>
      ...
      <option></option>
      <option{if $ad_date_end_ampm == "$admin_ads_add46"} selected='selected'{/if}>{$admin_ads_add46}</option>
      <option{if $ad_date_end_ampm == "$admin_ads_add47"} selected='selected'{/if}>{$admin_ads_add47}</option>
      </select>
    </div>
  </td>
  </tr>
  <tr>
  <td class='form1'>{$admin_ads_add51}</td>
  <td class='form2'>
    <table cellpadding='0' cellspacing='0'>
    <tr>
    ...
    <td><input type='checkbox' id='ad_limit_views' name='ad_limit_views_unlimited' value='1' class='checkbox'{if $ad_limit_views_unlimited != "unchecked"} checked='checked'{/if} onClick="togglefield('views_field', this)"> <label for='ad_limit_views'>{$admin_ads_add52}</label></td>
    </tr>
    </table>
  </td>
  </tr>
  <tr>
  <td class='form1'>{$admin_ads_add53}</td>
  <td class='form2'>
    <table cellpadding='0' cellspacing='0'>
    <tr>
    ...
    <td><input type='checkbox' id='ad_limit_clicks' name='ad_limit_clicks_unlimited' value='1' class='checkbox'{if $ad_limit_clicks_unlimited != "unchecked" OR $ad_limit_clicks_unlimited == ""} checked='checked'{/if} onClick="togglefield('clicks_field', this)"> <label for='ad_limit_clicks'>{$admin_ads_add52}</label></td>
    </tr>
    </table>
  </td>
  </tr>
  <tr>
  <td class='form1'>{$admin_ads_add54}</td>
  <td class='form2'>
    <table cellpadding='0' cellspacing='0'>
    <tr>
    ...
    <td><input type='checkbox' id='ad_limit_minctr' name='ad_limit_ctr_unlimited' value='1' class='checkbox'{if $ad_limit_ctr_unlimited != "unchecked" OR $ad_limit_clicks_unlimited == ""} checked='checked'{/if} onClick="togglefield('minctr_field', this)"> <label for='ad_limit_minctr'>{$admin_ads_add52}</label></td>
    </tr>
    </table>
  </td>
  </tr>
...
<table cellpadding='0' cellspacing='0' width='100%'>
<tr><td class='header'>{$admin_ads_add55}</td></tr>
<tr><td class='setting1'>
  {$admin_ads_add56}
</td></tr>
<tr><td class='setting2'>
...
<tr><td class='setting1'>
  ...
  <div style='text-align: center;'>
    <h3><b>{literal}{$ads->ads_display('{/literal}{$ad_id_next}{literal}')}{/literal}</b></h3>
  </div>
</td></tr>
</table>
...
<table cellpadding='0' cellspacing='0' width='100%'>
<tr><td class='header'>{$admin_ads_add58}</td></tr>
<tr><td class='setting1'>
  {$admin_ads_add59}
</td></tr>
<tr><td class='setting2'>
  ...
  <td style='padding-left: 10px;'><b>{$admin_ads_add60}</b></td>
  </tr>
  <tr>
  <td>
    ...
    {section name=level_loop loop=$levels}
      <option value='{$levels[level_loop].level_id}'{if $levels[level_loop].level_selected == 1} selected='selected'{/if}>{$levels[level_loop].level_name|truncate:75:"...":true}{if $levels[level_loop].level_default == 1} {$admin_ads_add61}{/if}</option>
    {/section}
    </select>
  </td>
...
<tr><td class='setting2'>
  <table cellpadding='0' cellspacing='0'>
  <tr>
  <td><input type='checkbox' name='ad_public' id='ad_public' value='1'{if $ad_public == 1 OR $task == "main"} checked='checked'{/if}></td>
  <td><label for='ad_public'>{$admin_ads_add62}</label></td>
  </tr>
  </table>
</td></tr>
</table>
...
<tr>
<td>
  <input type='submit' class='button' value='{$admin_ads_add63}'>&nbsp;
  <input type='hidden' name='task' value='dosave'>
  </form>
</td>
<td>
  <form action='admin_ads.php' method='post'>
  <input type='submit' class='button' value='{$admin_ads_add64}'>
  </form>
</td>
</tr>
</table>
