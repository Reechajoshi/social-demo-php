<?php /* Smarty version 2.6.14, created on 2012-03-03 03:46:21
         compiled from user_friends_requests.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'user_friends_requests.tpl', 37, false),)), $this); ?>
...
<tr>
<td class='tab0'>&nbsp;</td>
<td class='tab2' NOWRAP><a href='user_friends.php'><?php echo $this->_tpl_vars['user_friends_requests1']; ?>
</a></td>
<td class='tab'>&nbsp;</td>
<td class='tab1' NOWRAP><a href='user_friends_requests.php'><?php echo $this->_tpl_vars['user_friends_requests2']; ?>
</a></td>
<td class='tab'>&nbsp;</td>
<td class='tab2' NOWRAP><a href='user_friends_requests_outgoing.php'><?php echo $this->_tpl_vars['user_friends_requests19']; ?>
</a></td>
<td class='tab'>&nbsp;</td>
<td class='tab2' NOWRAP><a href='user_friends_settings.php'><?php echo $this->_tpl_vars['user_friends_requests18']; ?>
</a></td>
<td class='tab3'>&nbsp;</td>
</tr>
</table>
...
<div class='page_header'><?php echo $this->_tpl_vars['user_friends_requests3']; ?>
</div>
<div><?php echo $this->_tpl_vars['user_friends_requests4']; ?>
</div>
...
<?php if ($this->_tpl_vars['total_friends'] == 0): ?>
  ...
  <tr><td class='result'><img src='./images/icons/bulb16.gif' border='0' class='icon'><?php echo $this->_tpl_vars['user_friends_requests5']; ?>
</td></tr>
  </table>
...
'>&#171; <?php echo $this->_tpl_vars['user_friends_requests13']; ?>
</a><?php else: ?><font class='disabled'>&#171; <?php echo $this->_tpl_vars['user_friends_requests13']; ?>
</font><?php endif; ?>
    <?php if ($this->_tpl_vars['p_start'] == $this->_tpl_vars['p_end']): ?>
      &nbsp;|&nbsp; <?php echo $this->_tpl_vars['user_friends_requests14']; ?>
 <?php echo $this->_tpl_vars['p_start']; ?>
 <?php echo $this->_tpl_vars['user_friends_requests16']; ?>
 <?php echo $this->_tpl_vars['total_friends']; ?>
 &nbsp;|&nbsp; 
    <?php else: ?>
      &nbsp;|&nbsp; <?php echo $this->_tpl_vars['user_friends_requests15']; ?>
 <?php echo $this->_tpl_vars['p_start']; ?>
...
'><?php echo $this->_tpl_vars['user_friends_requests17']; ?>
 &#187;</a><?php else: ?><font class='disabled'><?php echo $this->_tpl_vars['user_friends_requests17']; ?>
 &#187;</font><?php endif; ?>
    </div>
  <?php endif; ?>
...
' border='0' alt="<?php echo $this->_tpl_vars['friends'][$this->_sections['friend_loop']['index']]->user_info['user_username'];  echo $this->_tpl_vars['user_friends_requests6']; ?>
"></a></td>
...
'><img src='./images/icons/user16.gif' border='0' class='icon'><?php echo $this->_tpl_vars['friends'][$this->_sections['friend_loop']['index']]->user_info['user_username']; ?>
      ...
      <table cellpadding='0' cellspacing='0'>
      <tr><td><?php echo $this->_tpl_vars['user_friends_requests6']; ?>
      ...
      <tr><td width='80'><?php echo $this->_tpl_vars['user_friends_requests7']; ?>
      ...
      <?php if ($this->_tpl_vars['friends'][$this->_sections['friend_loop']['index']]->friend_type != ""): ?><tr><td><?php echo $this->_tpl_vars['user_friends_requests8']; ?>
</td><td><?php echo $this->_tpl_vars['friends'][$this->_sections['friend_loop']['index']]->friend_type; ?>
</td></tr><?php endif; ?>
      <?php if ($this->_tpl_vars['friends'][$this->_sections['friend_loop']['index']]->friend_explain != ""): ?><tr><td><?php echo $this->_tpl_vars['user_friends_requests9']; ?>
...
&task=confirm'><?php echo $this->_tpl_vars['user_friends_requests10']; ?>
</a><br>
    <a href='user_friends_confirm.php?user=<?php echo $this->_tpl_vars['friends'][$this->_sections['friend_loop']['index']]->user_info['user_username']; ?>
&task=reject'><?php echo $this->_tpl_vars['user_friends_requests11']; ?>
</a><br>
...
'><?php echo $this->_tpl_vars['user_friends_requests12']; ?>
</a><br><?php endif; ?>
    </td>
    </tr>
    </table>
